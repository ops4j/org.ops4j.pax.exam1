...
/**
 * Annotation marking Pax Exam configuration method. The value of configuration is an array of regular expressions that
 * are matched against test method names (those methods marked with {@link org.junit.Test}).
